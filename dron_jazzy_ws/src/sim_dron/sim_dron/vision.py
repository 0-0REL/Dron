...
class vision(Node):
    def __init__(self):
        ...
        self.publisher = self.create_publisher(Vector3, 'vision_data', 10)
        ...
        package_share = get_package_share_directory('sim_dron')
        prototxt_path = os.path.join(package_share, 'modelos/deploy.prototxt')
        caffemodel_path = os.path.join(package_share, 'modelos/res10_300x300_ssd_iter_140000_fp16.caffemodel')
    ...
    def publicar_info(self, x, y, z):
        ...
        self.get_logger().info(f"Publicando datos de visión: x={x}, y={y}, z={z}")
    ...
    def procesar_frame(self):
        ...
        for i in range(detections.shape[2]):
            ...
            if confidence > self.conf_threshold:
                ...
                self.x = x_bottom_right*y_bottom_right
                self.y = x_top_left + x_bottom_right//2
                self.z = y_top_left + y_bottom_right//2
