...
A = np.array(   [[1.182041, 0.006722, -0.038571],
                [0.006722, 1.215828, -0.018906],
                [-0.038571, -0.018906, 1.130102]])
b = np.array([7.599156, 50.141646, -27.448182])


# Read raw data and apply calibration
rawData = np.genfromtxt('/home/rel/Documentos/repos/Dron/mag_read_converted.txt', delimiter='\t')  # Read raw measurements
